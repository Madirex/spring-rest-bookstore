...
INSERT INTO bookstore_user(id, name,surname,username, email, password,created_at,updated_at, is_deleted, roles)
VALUES ('6c8aeebf-8e5a-4381-805f-a2494262d6d7','admin','admin','admin','admin@admin.com','$2a$10$yNN.Yn.0ceXjIV7yWUD3sOMUXfvhJzPXCe.L.LnctxyLlWv2mXKSW',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,false,'ADMIN'),
